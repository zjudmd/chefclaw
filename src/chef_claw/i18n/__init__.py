...
MESSAGES: dict[LocaleCode, dict[str, str]] = {
    "en": {
        ...
        "inventory.batch_deleted": "Deleted batch {batch_id} for {name}.",
        "inventory.batch_updated": "Updated batch {batch_id} for {name}.",
        "inventory.consume_insufficient": "Only {quantity} of {name} could be confirmed for consumption.",
        "inventory.consume_line": "Consumed {quantity} of {name}.",
        "inventory.consume_no_match": "No confirmed stock found for {name}.",
        "inventory.consume_unknown_batches": "Some {name} batches still have unknown quantity.",
        ...
        "inventory.section.foods": "Prepared foods",
        "inventory.section.other": "Other",
    ...
    "zh-Hans": {
        ...
        "inventory.batch_deleted": "已删除 {name} 的批次 {batch_id}。",
        "inventory.batch_updated": "已更新 {name} 的批次 {batch_id}。",
        "inventory.consume_insufficient": "当前只能确认消耗 {quantity} 的 {name}。",
        "inventory.consume_line": "已消耗 {quantity} 的 {name}。",
        "inventory.consume_no_match": "当前没有可确认消耗的 {name} 库存。",
        "inventory.consume_unknown_batches": "{name} 仍有数量未确认的批次。",
        "inventory.item_line": "{name}: {quantity}",
        "inventory.item_line_with_date": "{name}: {quantity} | 最晚 {date} 前使用",
        "inventory.section.ingredients": "食材",
        "inventory.section.foods": "即食 / 熟食",
        "inventory.section.other": "其他",
